...
class Router(object):
    __slots__ = ['name','sim','flow_table','link_table','maintenance_cycle','autoack','longflowtmo','flowinactivetmo','debug','logger','__flowsampling','__pktsampling','exporter','counters','snmpexportinterval','snmpexportfile','snmpexportfh']
